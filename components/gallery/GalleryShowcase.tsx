 ...
 *
 * There used to be a dedicated Kids Zone tab here too — removed per client
 * direction now that /activities is the primary place Kids Zone is
 * presented (see content/gallery.ts's file-header note). Genuine dated Kids
 * Zone photos (e.g. `kids-face-painting-2025`) still appear in the ordinary
 * year tab they belong to; nothing about that flow changed.
 */
