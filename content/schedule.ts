...
export const scheduleEvents = z.array(ScheduleEventSchema).parse([
  ...
  // Studios", Sujaya -> "Team Natya"). The closing DJ's name is now spelled
  // "DJ Avatar" (was "DJ Avstar").
  ...
  { id: "fri-4", day: "fri", time: "6:15PM - 6:45PM", title: "Opening Music Ceremony (Kerala Drums & Violin)", type: "Music", performer: "Pratap", group: "Ottawa Mela Sangam" },
  ...
  { id: "fri-11", day: "fri", time: "9:00PM - 10:00PM", title: "DJ", type: "DJ", performer: "DJ Avatar" },
  ...
  //    Workshop" — note this spelling ("Pitaara") is exactly what the
  //    client's new sheet shows, though content/activities.ts's matching
  //    Aug 22 workshop entry spells it "D Creative Pitara Painting
  //    Workshop". Flagging this spelling difference for the client to
  //    confirm rather than silently reconciling the two pages.
  ...
  //    the same: "Music – Vocal" (Anukriti) -> "Bollywood Meadly" [sheet's
  //    own spelling, kept verbatim rather than silently corrected to
  //    "Medley" — flagging for confirmation]; "Dance – Classical" (Nikita)
  ...
  { id: "sat-2", day: "sat", time: "1:30PM - 2:30PM", title: "D Creative Pitaara Workshop", type: "Workshop" },
  ...
  { id: "sat-7", day: "sat", time: "4:00PM - 4:10PM", title: "Bollywood Meadly", type: "Music", performer: "Anukriti", group: "Anukriti Roy" },
  { id: "sat-8", day: "sat", time: "4:15PM - 4:25PM", title: "Garba Performance", type: "Dance", performer: "Nikita Gohel", group: "Brahmormi" },
  { id: "sat-9", day: "sat", time: "4:30PM - 5:00PM", title: "Tamil Melodies", type: "Vocals", performer: "Canadian Tamil Singers" },
  ...
  { id: "sun-6", day: "sun", time: "3:15PM - 3:45PM", title: "Bollywood Singing", type: "Music", performer: "Gautami & Siona" },
  ...
  { id: "sun-13", day: "sun", time: "4:15PM - 5:00PM", title: "Power Garba", type: "Dance", performer: "Hiral", group: "Garba with Hiral" },
